<template>
  <footer class="footer p-10 bg-base-200 text-base-content">
    <div>
      <img class="w-24" src="../assets/img/favicon.png">
      <p class="text-base w-72">Hiling Spot adalah platform penyedia informasi tempat hiling terbaik sesuai lokasi terdekat kamu.</p>
    </div>
    <div>
      <span class="footer-title">Services</span> 
      <a class="link link-hover">Your location</a> 
      <a class="link link-hover">Tourist attraction</a> 
      <a class="link link-hover">Nearest place</a> 
      <!-- <a class="link link-hover">Advertisement</a> -->
    </div> 
    <div>
      <span class="footer-title">Pages</span> 
      <a class="link link-hover"><router-link to="/about">About Us</router-link></a> 
      <a class="link link-hover"><router-link to="/">Home</router-link></a> 
<!--       <a class="link link-hover">Jobs</a> 
      <a class="link link-hover">Press kit</a> -->
    </div> 
    <div>
      <span class="footer-title">Spot</span> 
      <a class="link link-hover">Candi</a> 
      <a class="link link-hover">Pantai</a> 
      <a class="link link-hover">Museum</a>
      <a class="link link-hover">Goa</a>
      <a class="link link-hover">Air Terjun</a>
      <a class="link link-hover">Sungai</a>
    </div>
  </footer> 
  <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
    <div class="items-center grid-flow-col">
      ...
      <p>Hiling Spot Website. <br>Providing reliable tech since 1992</p>
    </div> 
